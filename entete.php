<header>
  ...
  ?>
    <span><i class="fa fa-user" aria-hidden="true"></i> Utilisateur : <?= $_SESSION["user"] ?> - 
          <?php
          if ($_SESSION["profil"] !== "livreur"){
          ?>
            <i class="fa fa-cart-plus" aria-hidden="true"></i> <a href="panier.php?userid=<?= $_SESSION["userid"] ?>">Mon Panier</a> - 
          <?php
          }
          ?>
          <i class="fa fa-cog" aria-hidden="true"></i> <a href="profil.php?id=<?= $_SESSION["userid"] ?>">Mon Profil</a> - <i class="fa fa-user-times" aria-hidden="true"></i> <a href="deconnexion.php">Deconnexion</a></span><br>
  <?php 
  }else{
  ?>
...
<ul class="nav nav-pills nav-fill gap-2 p-1 small bg-primary rounded-5 shadow-sm" id="pillNav2" role="tablist" style="--bs-nav-link-color: var(--bs-white); --bs-nav-pills-link-active-color: var(--bs-primary); --bs-nav-pills-link-active-bg: var(--bs-white);">
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link <?= $page == "livraisons" ? "active" : "" ?> rounded-5" id="livraisons-tab2" data-bs-toggle="tab" type="button" role="tab" aria-selected="true">Livraisons</button>
  </li>
  <?php
  }
  ?>
